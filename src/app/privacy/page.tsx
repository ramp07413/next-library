        ...
        <ScrollAnimation className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="prose prose-lg max-w-4xl mx-auto">
            ...
            <p>
              ...
              when you create an account, as well as information that is
              automatically collected when you use our services, like your IP
            ...
            <p>
              ...
              you, and to ensure the security of our platform.
            </p>
            ...
            <p>
              ...
              contact us at: contact@libman.com.
            </p>
          </div>
        </ScrollAnimation>
      </section>
