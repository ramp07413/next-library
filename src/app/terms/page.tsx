        ...
        <section className="py-20 lg:py-24">
          <ScrollAnimation className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="prose prose-lg max-w-4xl mx-auto">
              ...
              <p>Welcome to LibMan ("Company", "we", "our", "us")! These Terms of Service ("Terms", "Terms of Service") govern your use of our web pages located at [Your Website URL] operated by LibMan.</p>
              <p>Our Privacy Policy also governs your use of our Service and explains how we collect, safeguard and disclose information that results from your use of our web pages. Please read it here [Link to Privacy Policy].</p>
              ...
              <p>The Service and its original content, features and functionality are and will remain the exclusive property of LibMan and its licensors. The Service is protected by copyright, trademark, and other laws of and foreign countries.</p>
              ...
              <h3>7. Contact Us</h3>
              <p>Please send your feedback, comments, requests for technical support by email: contact@libman.com.</p>
            </div>
          </ScrollAnimation>
        </section>
      </main>
