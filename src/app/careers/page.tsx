...
import { FaBookOpen, FaMapMarkerAlt, FaHeart } from 'react-icons/fa';
import {
  Card,
  CardContent,
  CardHeader,
        ...
        <ScrollAnimation className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="mt-2 text-muted-foreground max-w-2xl mx-auto">
              We are looking for passionate and talented individuals to join our
              growing team.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-muted-foreground text-lg mb-6">
                Make a difference in your community by volunteering at one of
                our libraries. We have a variety of roles to suit your interests
                and availability.
              </p>
              ...
              <Button asChild className="mt-8">
                <Link href="/contact">
                  Become a Volunteer <FaHeart className="ml-2" />
                </Link>
              </Button>
            </div>
